"""
Django settings for atsuko_clone project.
...
SECRET_KEY = 'django-insecure-du0*@_@#jx^xrnsn*r#1fz%ab7tvu05dxfd4=#c77!cw^pb@^h'
...
WSGI_APPLICATION = 'atsuko_clone.wsgi.application'
